...
N_BLOCKS = 1
N_TRIALS = 20
# Define the position of our stimuli 
POSITION = {
    'left':  [-75, 0],
    'right': [+75, 0]
}
...
# =============================================================================
# LOAD THE TRIAL LIST (.csv file) AND SET UP THE OUTPUT/RESULTS FILE
# =============================================================================
...
trial_list = pd.read_csv('trial_list_1.csv')
print(trial_list.head())
...
if not os.path.exists('results'): # Create results folder if it doesn't exist
    os.makedirs('results')
output_name = 'results/' + str(info['Participant ID']) + '_results.csv'
...
# =============================================================================
# BLOCK AND TRIAL LOOPS
# =============================================================================
# We have all the ingredents: 
# - Hardware is set up (monitor, keyboard)
# - Task stimuli are set up (fixation, arrow)
# - We have uploaded our design with trial-by-trial information
# We're ready to go! :)
...
# =============================================================================
# SAVE OPUTPUT FILE & CLOSE EXPERIMENT
# =============================================================================
